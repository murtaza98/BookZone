...
<form method="GET" action="">
    <div class="container-fluid close_bookmark_sidebar autocomplete"  style="background-color: transparent; margin-top: 20px;">
        <div class="full-width-util input-group" id="searchBox">
            <input id="myInput" type="text" name="search_box"  class="form-control home-search-bar acInput" placeholder="Search by title, author, semester" autocomplete="off" style="width:100%;">
...
<script>
    ...
    autocomplete(document.getElementById("myInput"),document.getElementById("parent_element"), countries);
